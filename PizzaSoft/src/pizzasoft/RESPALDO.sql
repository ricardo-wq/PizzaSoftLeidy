CREATE DATABASE  IF NOT EXISTS `pizzeria` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `pizzeria`;
...
CREATE TABLE `cliente` (
  ...
  `nombreCliente` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `config` (
  ...
  `mensaje` varchar(300) COLLATE utf8mb4_general_ci NOT NULL
...
CREATE TABLE `pizzas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ingredientesDisponibles` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `precio_chica` decimal(10,2) DEFAULT NULL,
  `precio_grande` decimal(10,2) DEFAULT NULL,
  `precio_familiar` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `pizzas` VALUES (1,'1 Ingrediente',NULL,70.00,115.00,140.00),(2,'2 Ingredientes',NULL,90.00,135.00,160.00),(3,'3 Ingredientes',NULL,110.00,150.00,190.00),(4,'Pizza de Champiñon',NULL,100.00,160.00,180.00),(5,'Hawaiana',NULL,100.00,160.00,180.00),(6,'Pizza de Carnes Frías',NULL,130.00,195.00,235.00),(7,'Campechana',NULL,120.00,180.00,210.00),(8,'Pastor',NULL,120.00,200.00,270.00),(9,'Pastor Especial',NULL,180.00,295.00,350.00),(10,'Pizza Surtida',NULL,140.00,280.00,330.00),(11,'Carpizzio Especial',NULL,200.00,295.00,370.00);
...
CREATE TABLE `ventas` (
  ...
  `nombre_pizza` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tamanio_pizza` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ingredientes` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `precio_pizza` decimal(10,2) DEFAULT NULL,
  `complementos` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `precio_complemento` decimal(10,2) DEFAULT NULL,
  `ingredientesExtras` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2025-05-20  7:41:20
